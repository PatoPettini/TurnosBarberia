...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <asp:GridView ID="dgvTurnos" DataKeyNames="id" CssClass="table table-dark table-bordered" OnSelectedIndexChanged="dgvTurnos_SelectedIndexChanged" AutoGenerateColumns="false" runat="server">
            <Columns>
